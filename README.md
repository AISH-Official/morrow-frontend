...
Watch와 iPhone의 HealthKit 동기화는 최근 수면의 시작·종료 및 단계별 시간과 최근 운동의 종류·구간·에너지·거리·평균/최대 심박·추정 강도를 파생 요약으로 전송합니다. 웹과 iPhone의 `HEALTHKIT DETAILS`에서 확인할 수 있으며, 강도는 의료 판단이 아닌 심박·분당 활동 에너지 기반 참고값입니다.
